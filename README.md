 ...
 * In the folder  conjunto_de_datos_endutih_2024_csv are:
    ...
    * The results from the section III of the survey:
        * conjunto_de_datos_endutih_2024_csv\conjunto_de_datos\tr_endutih_residentes_anual_2024.csv
    *  The results from the section VII and V of the survey:
    ...
    * A entity–relationship model:
        * cojunto_de_datos_endutih_2024_csv\modelo_entidad_relacion\modelo_er_endutih_2024.jpg
